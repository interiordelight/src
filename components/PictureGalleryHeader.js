...
const renderDot = (currentSlideSrc, onDotClick) =>
  // eslint-disable-next-line func-names
  function (file) {
    return <PictureGalleryHeaderDot key={file} src={file} currentSlideSrc={currentSlideSrc} onDotClick={onDotClick} />;
  };

const onCloseClick = () => history.back();

function PictureGalleryHeader({ projectTitle, pictures, currentSlideSrc, onDotClick }) {
  return (
