...
export default () => (
  <Layout title={title}>
    ...
    <Content>
      ...
      <p>We never use the data gathered through cookies on this site to contact you via post, email or phone and we do not use cookies on this site to show you products and/or services advertising.</p>
      <p>Our partners' websites, to which we provide links from this site, may use cookies to show you subtly tailored content of things they think you might be interested in. Their own site cookie policies should explain how they use cookies to show you tailored content.</p>
      ...
      <p>We do use 'analytics' cookies on this site to help us make our website better for those who visit it regularly and in doing so we do share certain limited information with our third party "analytics" providers but none of that information can be traced to an individual.</p>

      <h4>What are cookies?</h4>
      <p>Cookies are small text files that are sent to and stored on your computer, smartphone or other device for accessing the Internet, whenever you visit a website. Cookies are useful because they allow a website to recognise a user's device. On this site, the cookies we use include "analytics" cookies, to analyse how users use this site and to help us make our website better for those who visit it regularly.</p>
      <p>Other websites may use cookies for a variety of other reasons including to determine preferences, let users navigate between pages efficiently, verify the user and carry out other essential security checks. Their own cookie policies should explain how they use cookies.</p>
      <p>Some of the functions that cookies perform can also be achieved using similar technologies. This policy refers to "cookies" throughout, however is to include these alternate mechanisms.</p>
      <p>More information about cookies can be found on <a href="http://www.allaboutcookies.org" target="_blank" rel="noopener noreferrer">allaboutcookies.org</a>.</p>
      ...
      <p>The browsers of most computers, smartphones and other web-enabled devices are typically set up to accept cookies. If you wish to amend your cookie preferences for this site or any other websites, you can do this through your browser settings. Your browser's "help" function will tell you how to do this.</p>
      <p>However, please remember that cookies are often used to enable and improve certain functions on our site. If you choose to switch certain cookies off, it is likely to affect how our site works.</p>
      <p>For more information about how to disable cookies, visit <a href="http://www.allaboutcookies.org" target="_blank" rel="noopener noreferrer">allaboutcookies.org</a>.</p>
