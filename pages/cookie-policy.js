    ...
    <Layout title={title}>
      ...
      <Content>
        ...
        <p>
          ...
          to create the most effective website possible for our users. Among other things, the cookies we use allow us
          to improve your experience when using our website and to ensure the website performs as you expect it to.
        </p>
        <p>
        ...
        <p>
          ...
          to ensure their websites performs as expected. Please bear in mind that our partners will have their own
          privacy and cookie policies that will govern their use of cookies.
        </p>
        ...
        <p>
          ...
          tailored content of things they think you might be interested in. Their own site cookie policies should
          explain how they use cookies to show you tailored content.
        </p>
        ...
        <p>
          Cookies can be used for a variety of reasons, such as to improve the functionality and performance of this
          site and safeguard your privacy when browsing.
        </p>
        <p>
        ...
        <p>
          However, please remember that cookies are often used to enable and improve certain functions on our site. If
          you choose to switch certain cookies off, it is likely to affect how our site works.
        </p>
        <p>
